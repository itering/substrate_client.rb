RSpec.describe SubstrateClient do
  before(:all) {
    @client = SubstrateClient.new("wss://kusama-rpc.polkadot.io/", spec_name: "kusama")
  }
  ...
  it "can call state_getPairs" do
    pairs = @client.state_getPairs("0x26aa394eea5630e07c48ae0c9558cef7b99d880ec681799c0cf30e8886371da9")
